...
@javax.annotation.Generated(
    ...
    comments = "Source: resources/rpc_medication.proto")
public final class MedicationGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.springdemo.rpc.RpcMedication.Patient,
      com.example.springdemo.rpc.RpcMedication.Med> getGetMedicationPlanMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetMedicationPlan",
      requestType = com.example.springdemo.rpc.RpcMedication.Patient.class,
      responseType = com.example.springdemo.rpc.RpcMedication.Med.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.example.springdemo.rpc.RpcMedication.Patient,
      com.example.springdemo.rpc.RpcMedication.Med> getGetMedicationPlanMethod() {
    io.grpc.MethodDescriptor<com.example.springdemo.rpc.RpcMedication.Patient, com.example.springdemo.rpc.RpcMedication.Med> getGetMedicationPlanMethod;
      ...
      synchronized (MedicationGrpc.class) {
        if ((getGetMedicationPlanMethod = MedicationGrpc.getGetMedicationPlanMethod) == null) {
          MedicationGrpc.getGetMedicationPlanMethod = getGetMedicationPlanMethod = 
              io.grpc.MethodDescriptor.<com.example.springdemo.rpc.RpcMedication.Patient, com.example.springdemo.rpc.RpcMedication.Med>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "Medication", "GetMedicationPlan"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.springdemo.rpc.RpcMedication.Patient.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.springdemo.rpc.RpcMedication.Med.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.springdemo.rpc.RpcMedication.Taken,
      com.example.springdemo.rpc.RpcMedication.Empty> getSendMedicationTakenMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendMedicationTaken",
      requestType = com.example.springdemo.rpc.RpcMedication.Taken.class,
      responseType = com.example.springdemo.rpc.RpcMedication.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.springdemo.rpc.RpcMedication.Taken,
      com.example.springdemo.rpc.RpcMedication.Empty> getSendMedicationTakenMethod() {
    io.grpc.MethodDescriptor<com.example.springdemo.rpc.RpcMedication.Taken, com.example.springdemo.rpc.RpcMedication.Empty> getSendMedicationTakenMethod;
      ...
      synchronized (MedicationGrpc.class) {
        if ((getSendMedicationTakenMethod = MedicationGrpc.getSendMedicationTakenMethod) == null) {
          MedicationGrpc.getSendMedicationTakenMethod = getSendMedicationTakenMethod = 
              io.grpc.MethodDescriptor.<com.example.springdemo.rpc.RpcMedication.Taken, com.example.springdemo.rpc.RpcMedication.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Medication", "SendMedicationTaken"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.springdemo.rpc.RpcMedication.Taken.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.springdemo.rpc.RpcMedication.Empty.getDefaultInstance()))
  ...
  public static abstract class MedicationImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getMedicationPlan(com.example.springdemo.rpc.RpcMedication.Patient request,
        io.grpc.stub.StreamObserver<com.example.springdemo.rpc.RpcMedication.Med> responseObserver) {
      asyncUnimplementedUnaryCall(getGetMedicationPlanMethod(), responseObserver);
    }

    /**
     */
    public void sendMedicationTaken(com.example.springdemo.rpc.RpcMedication.Taken request,
        io.grpc.stub.StreamObserver<com.example.springdemo.rpc.RpcMedication.Empty> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                com.example.springdemo.rpc.RpcMedication.Patient,
                com.example.springdemo.rpc.RpcMedication.Med>(
                  this, METHODID_GET_MEDICATION_PLAN)))
          .addMethod(
            getSendMedicationTakenMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                com.example.springdemo.rpc.RpcMedication.Taken,
                com.example.springdemo.rpc.RpcMedication.Empty>(
  ...
  public static final class MedicationBlockingStub extends io.grpc.stub.AbstractStub<MedicationBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<com.example.springdemo.rpc.RpcMedication.Med> getMedicationPlan(
        com.example.springdemo.rpc.RpcMedication.Patient request) {
    ...
    /**
     */
    public com.example.springdemo.rpc.RpcMedication.Empty sendMedicationTaken(com.example.springdemo.rpc.RpcMedication.Taken request) {
  ...
  public static final class MedicationFutureStub extends io.grpc.stub.AbstractStub<MedicationFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.springdemo.rpc.RpcMedication.Empty> sendMedicationTaken(
        com.example.springdemo.rpc.RpcMedication.Taken request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_MEDICATION_PLAN:
          serviceImpl.getMedicationPlan((com.example.springdemo.rpc.RpcMedication.Patient) request,
              (io.grpc.stub.StreamObserver<com.example.springdemo.rpc.RpcMedication.Med>) responseObserver);
          break;
        case METHODID_SEND_MEDICATION_TAKEN:
          serviceImpl.sendMedicationTaken((com.example.springdemo.rpc.RpcMedication.Taken) request,
              (io.grpc.stub.StreamObserver<com.example.springdemo.rpc.RpcMedication.Empty>) responseObserver);
          break;
        default:
  ...
  private static abstract class MedicationBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.springdemo.rpc.RpcMedication.getDescriptor();
    }
